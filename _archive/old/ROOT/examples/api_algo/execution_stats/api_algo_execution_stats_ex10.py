...
options = {
    "groupby": [
        {"function": "hist_label", "var": "TradeQuantityUSD", "par": 8}
    ],
    "select": [
        {"function": "min", "var": "DecayPM1m", "name": "MinDecay1m"},
        {"function": "avg", "var": "DecayPM1m", "name": "AvgDecay1m"},
        {"function": "max", "var": "DecayPM1m", "name": "MaxDecay1m"},
